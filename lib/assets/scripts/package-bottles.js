function PackageBottles() {
  ...
  if (isLoading) return /*#__PURE__*/React.createElement("div", {
    id: "bottle-preloader",
    className: "flex one-box-down"
  }, /*#__PURE__*/React.createElement("div", {
    id: "bottle-status",
    className: "flex justifit-content-center"
  }, /*#__PURE__*/React.createElement("div", {
    className: "mx-auto"
  ...
  return /*#__PURE__*/React.createElement("div", null, names.map(name => /*#__PURE__*/React.createElement(Bottle, {
    key: name,
    name: name
  })));
  function Bottle({
    ...
    const versions = [...new Set(bottles.map(b => b.version))];
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "display-6"
    }, versions.length, " version", versions.length === 1 ? "" : "s", " bottled")), /*#__PURE__*/React.createElement("table", {
